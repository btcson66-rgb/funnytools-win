...
export default {
  ...
  en: {
    ...
    labels: {
      ...
      safeRangeError: 'Min, max, and the complete range must stay within JavaScript safe integers.',
      ...
      cryptoError: 'This browser cannot provide a secure random source, so no result was generated.',
    },
