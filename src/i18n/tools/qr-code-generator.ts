...
export default {
  zh: {
    ...
    caseStudies: [
      {
        title: "活動報名連結",
        description: "把活動報名表做成 QR Code，下載 PNG 後先用手機測試再放進 A4 海報。",
      },
      {
        title: "海報連結測試",
        description: "為公開網頁建立 QR Code，確認網址有效、尺寸足夠且有留白。",
      },
      {
        title: "??? Wi-Fi ??",
        description: "將訪客 Wi-Fi 資訊做成 QR Code，現場使用前確認分享這些資訊是安全且允許的。",
      },
    ],
    notes: [
      "QR Code 本身只是把內容編碼成圖片，不會替你檢查連結是否有效、是否有 HTTPS、是否需要登入或是否會過期。發布前請點開目標網址，確認手機版頁面、表單權限、Wi-Fi 密碼與追蹤參數都正確。",
