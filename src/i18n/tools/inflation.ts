...
export default {
  zh: {
    name: '通膨購買力試算',
    short: '估算通膨對未來購買力的影響。',
    long: '通膨試算器用金額、年通膨率與年數估算未來成本、未來購買力，或把過去金額向前換算成現在等值。公式：未來成本／過去金額的現在等值 = 金額 × (1 + 年通膨率)^年數；未來購買力 = 金額 ÷ (1 + 年通膨率)^年數。',
    seoTitle: '通膨計算器｜購買力與未來成本試算',
    seoDescription: '輸入金額、年通膨率與年數，估算未來成本、未來購買力或過去金額的現在等值。',
    keywords: ['通膨計算器', '購買力', 'inflation calculator', 'future value'],
    instructions: [
      '輸入目前金額、年通膨率與年數。',
      '選擇要估算未來成本、未來購買力，或把過去金額換算成現在等值。',
      '查看調整後金額、差額與使用公式。',
      '複製摘要以便放入筆記或規劃表。',
    ],
    examples: [
    ...
    formula: {
      expression: '未來成本／過去金額的現在等值 = 金額 × (1 + 年通膨率)^年數；未來購買力 = 金額 ÷ (1 + 年通膨率)^年數',
    ...
    faq: [
      ...
      {
        q: '過去金額的現在等值怎麼算？',
        a: '這個模式把過去金額向前帶到現在，因此乘上累積通膨因子；它不是把現在金額倒推回過去。',
      },
      {
        q: '這會使用官方 CPI 資料嗎？',
    ...
    labels: {
      ...
      change: '差額',
      formula: '使用公式',
      formulaMultiply: '金額 × (1 + 年通膨率)^年數',
      formulaDivide: '金額 ÷ (1 + 年通膨率)^年數',
      invalidInput: '金額須為非負數，年通膨率須介於 -99.99% 到 1,000%，年數須為 0 到 200 的整數。',
      copied: '已複製',
    },
  ...
  en: {
    ...
    long: 'Inflation Calculator estimates future cost, future purchasing power, or the present equivalent of a past amount from an amount, annual inflation rate, and years. Formula: future cost / present equivalent of a past amount = amount × (1 + annual rate)^years; future purchasing power = amount ÷ (1 + annual rate)^years.',
    seoTitle: 'Inflation Calculator | Purchasing Power Estimator',
    seoDescription: 'Enter amount, annual inflation rate, and years to estimate future cost, future purchasing power, or the present equivalent of a past amount.',
    ...
    formula: {
      expression: 'Future cost / present equivalent of a past amount = amount × (1 + annual inflation rate)^years; buying power = amount ÷ (1 + annual inflation rate)^years',
    ...
    faq: [
      ...
      {
        q: 'How is the present equivalent of a past amount calculated?',
        a: 'That mode moves a past amount forward to the present, so it multiplies by the accumulated inflation factor. It does not move a current amount backward in time.',
      },
      {
    ...
    labels: {
      ...
      pastEquivalent: 'Present equivalent of a past amount',
      calculate: 'Calculate',
      copy: 'Copy result',
      reset: 'Reset',
      ...
      formulaMultiply: 'amount × (1 + annual rate)^years',
      formulaDivide: 'amount ÷ (1 + annual rate)^years',
      invalidInput: 'Use a non-negative amount, a rate from -99.99% to 1,000%, and a whole number of years from 0 to 200.',
      copied: 'Copied',
    },
