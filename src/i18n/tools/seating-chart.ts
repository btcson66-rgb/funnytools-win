...
export default {
  zh: {
    ...
    labels: {
      ...
      csvColumn: '欄',
      csvName: '姓名',
      csvFilename: '教室座位表.csv',
      emptySeat: '空位',
      emptyResult: '座位表會顯示在這裡',
      emptyListError: '請至少輸入一位學生。',
      duplicateListError: '名單含有完全相同的姓名，請加上編號、姓氏縮寫或暱稱加以區分。',
      invalidGrid: '列數與欄數必須是 1 到 20 的整數。',
      tooManyStudents: '學生人數超過座位數，請增加列數或欄數。',
      cryptoError: '此瀏覽器無法提供安全亂數，因此沒有產生隨機座位表。你可以關閉隨機洗牌後再試。',
      copied: '已複製',
    },
  ...
  en: {
    ...
    labels: {
      ...
      csvColumn: 'Column',
      csvName: 'Name',
      csvFilename: 'classroom-seating-chart.csv',
      emptySeat: 'Empty',
      emptyResult: 'Seating chart appears here',
      emptyListError: 'Enter at least one student.',
      duplicateListError: 'The list contains identical names. Add a number, last initial, or nickname so every seat can be identified.',
      ...
      cryptoError: 'This browser cannot provide secure randomness, so no shuffled chart was generated. Turn off Shuffle to keep the original order.',
      copied: 'Copied',
    },
