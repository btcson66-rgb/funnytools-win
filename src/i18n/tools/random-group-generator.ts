...
export default {
  zh: {
    ...
    labels: {
      ...
      cryptoError: '此瀏覽器無法提供安全亂數來源，因此沒有產生分組。',
      csvFileName: 'random-groups.csv',
    },
  ...
  en: {
    ...
    labels: {
      ...
      cryptoError: 'This browser cannot provide a secure random source, so no groups were generated.',
      csvFileName: 'random-groups.csv',
    },
