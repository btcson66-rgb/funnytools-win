...
export default {
  zh: {
    ...
    labels: {
      ...
      downloadFilename: 'flowchart.png',
      maxNodes: '最多可建立 20 個節點。',
      connectionExists: '這兩個節點已有相同方向的箭頭。',
    },
  ...
  en: {
    ...
    labels: {
      ...
      downloadFilename: 'flowchart.png',
      maxNodes: 'This canvas supports up to 20 nodes.',
      connectionExists: 'Those nodes already have an arrow in that direction.',
    },
