...
export default {
  zh: {
    name: '實領薪資試算',
    short: '估算扣除項目後的月實領金額。',
    long: '實領薪資試算器用你輸入的月薪、津貼與可編輯扣除率估算實領金額。公式：實領薪資 = 薪資 + 津貼 - 薪資 ×（勞保率 + 健保率 + 退休提撥率 + 扣繳稅率）- 其他固定扣除。',
  ...
  en: {
    ...
    long: 'Net Salary estimates monthly take-home pay from salary, allowances, and editable deduction rates. Formula: net salary = salary + allowance - salary × (labor insurance rate + health insurance rate + pension rate + withholding tax rate) - other fixed deductions.',
