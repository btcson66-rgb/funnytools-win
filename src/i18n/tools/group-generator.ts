...
export default {
  zh: {
    ...
    labels: {
      ...
      cryptoError: '此瀏覽器無法提供安全亂數，因此沒有產生隨機分組。你可以關閉隨機洗牌後再試。',
      copied: '已複製',
    },
  ...
  en: {
    ...
    labels: {
      ...
      csvGroup: 'Group',
      csvMember: 'Member',
      csvFilename: 'class-groups.csv',
      reset: 'Reset',
      groupLabel: 'Group {n}',
      summary: 'Group summary',
      emptyResult: 'Generated groups appear here',
      emptyError: 'Enter at least two students.',
      duplicateListError: 'The list contains identical names. Add a number, last initial, or nickname so each member can be identified.',
      ...
      cryptoError: 'This browser cannot provide secure randomness, so no shuffled groups were generated. Turn off Shuffle to keep the original order.',
      copied: 'Copied',
    },
