...
export const guideAffiliateConfig: Record<string, GuideAffiliateConfig> = {
  ...
  'print-one-page-website-guide': { affiliateEnabled: true, affiliateCategory: 'office', affiliateTags: ['printing', 'document', 'office'] },
  'compress-pdf-10mb-guide': { affiliateEnabled: true, affiliateCategory: 'office', affiliateTags: ['pdf', 'document', 'computer'] },
  'qr-code-print-size-guide': { affiliateEnabled: true, affiliateCategory: 'office', affiliateTags: ['printing', 'document', 'office'] },
  'image-compression-email-guide': { affiliateEnabled: true, affiliateCategory: 'computer', affiliateTags: ['image', 'creator', 'computer'] },
  'image-format-comparison-guide': { affiliateEnabled: true, affiliateCategory: 'computer', affiliateTags: ['image', 'creator', 'computer'] },
  ...
  'seating-chart-strategies-guide': { affiliateEnabled: true, affiliateCategory: 'teacher', affiliateTags: ['teacher', 'classroom', 'office'] },
  'household-physics-demos-guide': { affiliateEnabled: true, affiliateCategory: 'home', affiliateTags: ['home', 'stem', 'teacher'] },
  'homework-timer-guide': { affiliateEnabled: true, affiliateCategory: 'student', affiliateTags: ['student', 'study', 'productivity'] },
