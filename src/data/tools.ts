...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['random-number-picker', 'random-name-picker', 'random-wheel', 'group-generator', 'grade-average'],
    assetType: 'tool',
    searchIntent: 'medium',
    shareIntent: 'medium',
    embedPotential: 'high',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['split-pdf', 'rotate-pdf', 'images-to-pdf', 'pdf-to-image', 'pdf-compressor'],
    assetType: 'tool',
    searchIntent: 'high',
    shareIntent: 'low',
    embedPotential: 'low',
