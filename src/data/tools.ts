...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['random-wheel', 'random-number-picker', 'random-group-generator', 'dice-roller', 'this-or-that', 'group-generator', 'random-student-picker'],
    assetType: 'tool',
    searchIntent: 'high',
    shareIntent: 'high',
    embedPotential: 'high',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['random-number-picker', 'random-wheel', 'random-name-picker', 'this-or-that'],
    assetType: 'tool',
    searchIntent: 'high',
    shareIntent: 'high',
    embedPotential: 'high',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['jpg-to-png', 'image-compressor', 'image-resizer', 'jpg-to-webp', 'webp-to-jpg'],
    assetType: 'tool',
    searchIntent: 'high',
    shareIntent: 'low',
    embedPotential: 'medium',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['barcode-generator', 'url-encoder', 'image-to-base64', 'color-generator', 'png-to-jpg', 'password-generator', 'image-compressor'],
    assetType: 'generator',
    searchIntent: 'high',
    shareIntent: 'medium',
    embedPotential: 'high',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['qr-code-generator', 'image-to-base64', 'png-to-jpg', 'image-compressor'],
    assetType: 'generator',
    searchIntent: 'high',
    shareIntent: 'medium',
    embedPotential: 'medium',
    ...
    isNew: true,
    updated: '2026-07-13',
    name: { zh: '條碼產生器', en: 'Barcode Generator' },
    short: { zh: '產生 Code 128、EAN-13、UPC-A 或 Code 39 條碼並下載 PNG、SVG。', en: 'Create Code 128, EAN-13, UPC-A, or Code 39 barcodes as PNG or SVG.' },
  },
  {
    slug: 'merge-pdf',
    category: 'pdf',
  ...
  },
  {
    ...
    status: 'live',
    privacyLevel: 'local-only',
    relatedTools: ['random-student-picker', 'random-name-picker', 'seating-chart', 'random-group-generator'],
    assetType: 'tool',
    searchIntent: 'high',
    shareIntent: 'medium',
    embedPotential: 'high',
